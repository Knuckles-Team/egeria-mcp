...
|----------|----------|-------|
| `EGERIA_PLATFORM_URL` | ✅ | OMAG platform URL (default `[configured-endpoint]`) |
| `EGERIA_VIEW_SERVER` | ✅ | View server name (default `qs-view-server`) |
| `EGERIA_USER` / `EGERIA_USER_PASSWORD` | ✅ | View-server credentials |
| `EGERIA_TLS_PROFILE` | optional | Runtime TLS profile selector; certificate and hostname verification are mandatory |
